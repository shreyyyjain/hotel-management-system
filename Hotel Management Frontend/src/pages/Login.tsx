    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-neutral-50 via-neutral-100 to-neutral-50 px-4 py-8">
      <div className="w-full max-w-lg space-y-10 bg-white/95 backdrop-blur-sm p-12 sm:p-16 rounded-3xl shadow-2xl">
        <div className="space-y-4">
          <h2 className="font-heading text-5xl sm:text-6xl text-center font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-purple-600 uppercase">
            🏨 Hotel
          </h2>
          <p className="text-center text-xl sm:text-2xl text-purple-600 font-semibold">
            Welcome back!
          </p>
        ...
        <form className="mt-10 space-y-8" onSubmit={handleSubmit}>
          ...
          <div className="text-center pt-4">
            <p className="text-base text-gray-700">
              ...
              <Link to="/signup" className="font-bold text-purple-600 hover:text-blue-600 transition-colors">
                Sign up here
              </Link>
            </p>
          </div>
